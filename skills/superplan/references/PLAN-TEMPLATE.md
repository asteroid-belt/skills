...
This is the complete template for `docs/superplan/YYYY-mm-dd-feature-short-name/plan.md` files.
...
> **Plan Directory**: `docs/superplan/YYYY-mm-dd-feature-short-name/`
